...
public class FinancialReportData extends HBaseTable {
	...
	public class ItemFamily extends HBaseColumnFamily {
		...
		public ItemValue getLatestValue(String elementId, String periodType,
				Date instant) {
			ItemQualifier qual = this.new ItemQualifier(elementId, periodType,
					instant);
			return (ItemValue) getLatestValue(qual);
		}
	...
	public class RatioFamily extends HBaseColumnFamily {
		...
		public RatioValue getLatestValue(String name, Date date) {
			RatioQualifier qual = this.new RatioQualifier(name, date);
			return (RatioValue) getLatestValue(qual);
		}

		public void add(String name, Date date, Date version, BigDecimal value) {
			HBaseColumnQualifier qual = this.new RatioQualifier(name, date);
			add(qual, version, value);
		}
		...
		public class RatioQualifier extends HBaseColumnQualifier {
			...
			public RatioQualifier(String name, Date date) {
				super();
				this.name = name;
				this.date = date;
			}
			...
			public byte[] toBytes() {
				...
				return ArrayUtility.addAll(nameBytes, SPACE, dateBytes);
			}
	...
	public class GrowthFamily extends HBaseColumnFamily {
		...
		public GrowthValue getLatestValue(String elementId, String periodType,
				Date instant) {
			GrowthQualifier qual = this.new GrowthQualifier(elementId,
					periodType, instant);
			return (GrowthValue) getLatestValue(qual);
		}
