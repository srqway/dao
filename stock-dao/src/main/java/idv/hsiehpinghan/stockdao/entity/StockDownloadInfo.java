...
public class StockDownloadInfo extends HBaseTable {
	...
	public class RowKey extends HBaseRowKey {
		...
		public RowKey(StockDownloadInfo entity) {
			super(entity);
		}

		public RowKey(String tableName, StockDownloadInfo entity) {
			super(entity);
			this.tableName = tableName;
		}

		public RowKey(byte[] rowKey, StockDownloadInfo entity) {
			super(entity);
			fromBytes(rowKey);
		}
	...
	public class StockCodeFamily extends HBaseColumnFamily {
		private StockCodeFamily(StockDownloadInfo table) {
			super(table);
		}
	...
	public class ReportTypeFamily extends HBaseColumnFamily {
		private ReportTypeFamily(StockDownloadInfo table) {
			super(table);
		}
	...
	public class YearFamily extends HBaseColumnFamily {
		private YearFamily(StockDownloadInfo table) {
			super(table);
		}
	...
	public class SeasonFamily extends HBaseColumnFamily {
		private SeasonFamily(StockDownloadInfo table) {
			super(table);
		}
